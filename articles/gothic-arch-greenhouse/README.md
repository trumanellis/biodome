...
![Cross-section diagram of the Gothic Arch greenhouse showing a 6.5m apex over a 3m base, with 1m vertical wall before the curve begins, and twin parallel ridge poles 30cm apart at the apex creating the continuous vent gap](images/fig-gothic-section.svg)
...
![Top-down plan view of the Gothic Arch greenhouse foundation showing 12 postholes in two parallel rows, gable doors at each end, and dimensions|697](images/fig-gothic-plan.svg)
...
![Three people raising the second pole of an arch on a Portuguese hillside — two at the base leaning the pole vertical, one on the ladder pulling the thin end inward with a rope](images/gothic-greenhouse-raising-arch.png)
...
![Three-panel diagram showing the tall arch raising sequence — first arch braced with diagonal props, second arch added with twin ridge poles connecting them, then the remaining arches following with the ridges keeping everything aligned](images/fig-gothic-raising.svg)
...
![The bare eucalyptus-pole skeleton of the Gothic Arch greenhouse standing on a Portuguese hillside under blue sky — six gothic arches, twin parallel ridge poles, three purlins per side, full structure visible before plastic skin goes on](images/gothic-greenhouse-bare-frame.png)
...
![End-view diagram of the tunnel showing the two 8m × 10m plastic sheets, one on each slope, meeting at the apex with a 30cm ridge vent gap, with a hinged vent cap above](images/fig-gothic-drape.svg)
...
![Side view of the finished Gothic Arch greenhouse with plastic skin installed and roll-up walls down, weighted with stones along the long base edge — gable door at the far end, terraced hillside in the background](images/gothic-greenhouse-side-ventilation.png)
...
![Side-view diagram showing the ridge vent in operation — vent cap propped open with sticks, hot air rising and exiting through the ridge gap, cool air entering through the doors and roll-up walls](images/fig-gothic-ventilation.svg)
...
![Front-on view of the Gothic Arch greenhouse from the gable end — sharp pointed apex silhouetted against blue sky, door open in the centre with green plants visible growing along the central path, olive trees framing the structure on either side](images/gothic-greenhouse-front-gable.png)
...
![The Gothic Arch greenhouse on a terraced Portuguese hillside at golden hour — three-quarter view showing the full gothic silhouette, plants visible inside through the translucent plastic, eucalyptus forest and terraced slopes in the background](images/gothic-greenhouse-interior-tunnel.png)
