...
description: "Introduction to the 35m² Earth Sheltered SolarPod — hillside cut, Da Vinci bridge rafters, earth thermal mass, and solar-ready A-frame roof."
---

import ModelViewer from '../../../components/ModelViewer.astro';

<figure>
  <img src="/assets/EarthShelteredRendering1.png" alt="Earth Sheltered SolarPod built into hillside with solar panels and living roof" />
  <figcaption>Earth Sheltered SolarPod — cut into the hillside with Da Vinci bridge rafters, solar panels, and living roof</figcaption>
</figure>
...
<figure>
  <img src="/assets/DeepLiving.png" alt="Earth-sheltered domes with large greenhouse plastic fronts nestled in native oak forest" loading="lazy" />
  <figcaption>South-facing greenhouse plastic front brings light deep into the earth-sheltered interior</figcaption>
</figure>

<div class="stats-grid">
  <div class="stat-card"><span class="stat-value">5 × 6m</span><span class="stat-label">Footprint</span></div>
  <div class="stat-card"><span class="stat-value">35m²</span><span class="stat-label">Sheltered Area</span></div>
