...
<figure>
  <img src="/assets/render-standard-ch2-site-layout.svg" alt="Site layout plan showing dome footprint, access paths, and staging areas" />
  <figcaption>Site layout: dome footprint, pole storage area, mixing station, and access paths</figcaption>
</figure>
...
<figure>
  <img src="/assets/render-standard-ch4-ring-beam-overview.svg" alt="Ring beam structural overview showing pole connections at the dome perimeter" />
  <figcaption>Ring beam overview: how the arch poles connect at the foundation and crown</figcaption>
</figure>
