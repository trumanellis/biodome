...
1. **First Pair**
   ...
   <figure>
     <img src="/assets/render-standard-ch5-center-tower.svg" alt="Temporary center support tower for dome frame assembly" />
     <figcaption>The temporary center post guides the first arch pair into position</figcaption>
   </figure>
...
6. **Secure the Crown**
   ...
   <figure>
     <img src="/assets/render-standard-ch5-closure-move.svg" alt="Crown closure detail showing all 16 poles crossing at the apex" />
     <figcaption>The crown crossing — all 16 poles lashed together as the structural keystone</figcaption>
   </figure>
...
7. **Lock Pole Bases**
   ...
   <figure>
     <img src="/assets/render-shared-ch6-saddle-notch.svg" alt="Saddle notch joint detail for pole-to-pole connections" />
     <figcaption>Saddle notch: a traditional joint for secure pole-to-pole connections</figcaption>
   </figure>
