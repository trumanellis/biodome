...
<figure>
  <img src="/assets/gabion-cage.jpg" alt="Gabion cage filled with local stone" loading="lazy" />
  <figcaption>Gabion cage: wire mesh filled with local stone — the foundation of every BioDome</figcaption>
</figure>

<figure>
  <img src="/assets/render-standard-ch5-gabion-foundation.svg" alt="Gabion foundation layout for the Standard BioDome" />
  <figcaption>Gabion ring with integrated drainage and pole socket positions</figcaption>
</figure>

<figure>
  <img src="/assets/stone-wall-water-channel.jpg" alt="Stone wall alongside traditional water channel" loading="lazy" />
  <figcaption>Traditional stone-and-water infrastructure — the same principles underpin our French drain integration</figcaption>
</figure>
