...
<figure>
  ...
  <figcaption>Greenhouse plastic over the wattle frame — dry inside, light coming through</figcaption>
</figure>
...
<CardGrid>
  ...
  <Card title="Earth Sheltered SolarPod" icon="rocket">
    30m² earth-sheltered — cut into hillside, Da Vinci bridge rafters.
...
<figure>
  <img src="/assets/BioDomeVillageAerial.png" alt="Aerial view of a BioDome village community with multiple glass domes in a mountain valley" loading="lazy" />
  <figcaption>The village-scale vision: a community of BioDomes nestled into the restored landscape</figcaption>
</figure>
